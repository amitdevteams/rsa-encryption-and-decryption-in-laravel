                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" name="user_security_token" id="user_security_token" maxlength="16" class="form-control" autocomplete="off" />
                ...
                <div class="modal-body">
                    ...
                    <form id="encrypt_form" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="vi_token_id" name="token" multiple="multiple">
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.getting_decrypt_data_email != undefined) {
                                    ...
                                    console.log('what is coming in name field'+ user_name);
