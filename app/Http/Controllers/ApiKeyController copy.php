...
class ApiKeyController extends Controller
{
    ...
    {   
        ...
        log::info('private key me kya aa rha hai'.$privkey);
    ...
    public function api_store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($gets_apis_data === NULL) {
                ...
                $options = 0;
                $name_encrypt = openssl_encrypt($getting_name, $chiper, $key, $options, $iv, $tag);
                $email_encrypt = openssl_encrypt($getting_email, $chiper, $key, $options, $iv, $tag);
                $city_encrypt = openssl_encrypt($getting_city, $chiper, $key, $options, $iv, $tag);
